...
(function() {
  ...
  CoffeeScriptInstrumenter = (function() {
    ...
    CoffeeScriptInstrumenter.prototype.instrument = function(filename, code, options) {
      var ast, compileOptions, err, instrumentTree, ref, referencedVars, result, token, tokens, traceFunc;
      if (options == null) {
        options = {};
      }
        ...
        return function(node, nodeIndex, parent, inCode) {
          ...
          if (node instanceof _this.nodeTypes.Block && !(parent instanceof _this.nodeTypes.Parens)) {
            ...
            if (node.icedContinuationBlock) {
              children.push(node.icedContinuationBlock);
            }
            childIndex = 0;
            ...
            if (parent instanceof _this.nodeTypes.Code) {
              ...
              if (children.length === 1) {
                ...
                if (!(lastExpr instanceof _this.nodeTypes.Return || lastExpr instanceof _this.nodeTypes.Await)) {
                  tempVariableName = _this.temporaryVariable("tempReturnVal", referencedVars);
            ...
            if (node.icedContinuationBlock != null) {
              return instrumentTree(node.icedContinuationBlock, null, node, inCode);
            }
          }
        };
      })(this);
